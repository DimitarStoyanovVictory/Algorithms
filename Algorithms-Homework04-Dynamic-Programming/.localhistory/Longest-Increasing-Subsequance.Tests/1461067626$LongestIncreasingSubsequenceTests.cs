...
using System.Linq;
using LongestIncreasingSubsequence = LongestIncreasingSubsequence.LongestIncreasingSubsequence;
...
public class LongestIncreasingSubsequenceTests
{
    ...
    public void Test11Numbers()
    {
        ...
        var expectedSeq = new int[] { 3, 5, 7, 8, 9, 10 };
    ...
    public void Test23Numbers()
    {
        ...
        var expectedSeq = new[] { 3, 5, 7, 8, 9, 10, 12, 13, 14,
            15, 16, 17, 18, 19, 20 };
        var actualSeq = LongestIncreasingSubsequence.
            FindLongestIncreasingSubsequence(sequence);
        CollectionAssert.AreEqual(expectedSeq, actualSeq);
