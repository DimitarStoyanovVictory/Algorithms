using LongestCommonSubsequenceApp
...
public class LongestCommonSubsequenceTests
{
    ...
    public void TestSimilarLongStrings()
    {
        ...
        var second = "In dynmic prgamming we break th oriinal problem to smaler subprobems that have the same struture";
        var expectedLCS = "dynmic prgamming we brak th oiinal prolem to smaler subprobms that have the same strture";
        var actualLCS = LongestCommonSubsequence.
            FindLongestCommonSubsequence(first, second);
    ...
    public void TestSingleLetter()
    {
        ...
        var expectedLCS = "a";
        var actualLCS = LongestCommonSubsequence.
            FindLongestCommonSubsequence(first.Length - 1, second.Length - 1);
        Assert.AreEqual(expectedLCS, actualLCS);
    }
