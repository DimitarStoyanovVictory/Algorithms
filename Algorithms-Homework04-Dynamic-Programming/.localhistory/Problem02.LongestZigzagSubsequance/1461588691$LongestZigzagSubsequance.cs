            ...
            while (index < inputNum.Length)
            {
                ...
                else if (predicateNum && zigzagSequance.Last() < inputNum[index] && !zigzagSequance.Contains(inputNum[index]))
                {
                    if (specialNumAllowed)
                    {
                        ...
                        specialSequanceLength = zigzagSequance.Count;
                ...
                else if (!predicateNum && zigzagSequance.Last() > inputNum[index] && !zigzagSequance.Contains(inputNum[index]))
                {
                    if (specialNumAllowed)
                    {
                        CheckForSpecialCase(ref specialNum, ref specialSequanceLength, ref specialNumAllowed, zigzagSequance.Last(), zigzagSequance.Count));
                    }
                ...
                if (specialNumAllowed && specialSequanceLength == zigzagSequance.Count)
                {
                    zigzagSequance.Remove(zigzagSequance.Last());
