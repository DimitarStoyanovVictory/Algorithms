namespace LongestCommonSubsequence
{
    ...
    public class LongestCommonSubsequence
    {
        ...
        public static int FindLongestCommonSubsequence(string firstStr, string secondStr)
        {
            ...
            return CalcLCS(firstStr.Length, secondStr.Length, lcs, firstStr, secondStr);
        }
        ...
        static void PrintLCS(string firstStr, string secondStr)
        {
            Console.WriteLine("LCS = " + FindLongestCommonSubsequence(firstStr.Length, secondStr.Length));

            List<char> lcsLetters = new List<char>();
            while (firstStr.Length >= 0 && secondStr.Length >= 0)
            {
                if ((firstStr[firstStr.Length] == secondStr[secondStr.Length]) &&
                    (FindLongestCommonSubsequence(firstStr.Length - 1, secondStr.Length - 1) + 1 == lcs[firstStr.Length, firstStr.Length]))
                {
