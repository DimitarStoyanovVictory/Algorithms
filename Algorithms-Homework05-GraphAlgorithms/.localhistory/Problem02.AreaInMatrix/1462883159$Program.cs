namespace Problem02.AreaInMatrix
{
    ...
    class Program
    {
            ...
            for (int row = 0; row < inputMatrix.GetLength(0); row++)
            {
                for (int col = 0; col < inputMatrix.GetLength(1); col++)
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            AddArea(areas, inputMatrix[tempRow + 1, tempCol]);
                            visited[tempRow + 1, tempCol] = true;
                            visited[tempRow, tempCol] = true;
                            tempRow++;
                        }
                        ...
                        {
                            AddArea(areas, inputMatrix[tempRow, tempCol + 1]);
        ...
        private static void AddArea(ref Dictionary<char, int> areas, char character)
        {
