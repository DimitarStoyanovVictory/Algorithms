                ...
                for (int col = 0; col < inputMatrix.GetLength(1); col++)
                {
                    ...
                    while (true)
                    {
                        if ((IsValid(tempRow - 1, tempCol, inputMatrix) && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol])
                            || (!visited[tempRow - 1, tempCol] && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol]) || (inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol]))
                        {
                            ...
                            || (inputMatrix[tempRow, tempCol] == inputMatrix[tempRow + 1, tempCol]))
                        {
                            visited[tempRow + 1, tempCol] = true;
                            visited[tempRow, tempCol] = true;
                            tempRow++;
