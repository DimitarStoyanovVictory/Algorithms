        ...
        static void Main()
        {
            ...
            for (int row = 0; row < inputMatrix.GetLength(0); row++)
            {
                for (int col = 0; col < inputMatrix.GetLength(1); col++)
                {
                    ...
                    while (true)
                    {
                        if ((IsValid(tempRow - 1, tempCol, inputMatrix) && !visited[tempRow - 1, tempCol] && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol]) || (inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol]))
                            || (IsValid(tempRow - 1, tempCol, inputMatrix) && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow - 1, tempCol])
                        {
                            ...
                            || (IsValid(tempRow + 1, tempCol, inputMatrix) && !visited[tempRow + 1, tempCol] && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow + 1, tempCol]) || (inputMatrix[tempRow, tempCol] == inputMatrix[tempRow + 1, tempCol]))
                        {
                            visited[tempRow + 1, tempCol] = true;
                            visited[tempRow, tempCol] = true;
                            tempRow++;
                            ...
                            || (IsValid(tempRow, tempCol + 1, inputMatrix) && !visited[tempRow, tempCol + 1] && inputMatrix[tempRow, tempCol] == inputMatrix[tempRow, tempCol + 1]) || (inputMatrix[tempRow, tempCol] == inputMatrix[tempRow, tempCol + 1]))
                        {
                        ...
                        {
                            AddArea(ref areas, inputMatrix[tempRow, tempCol]);
                            break;
                        }
                    }
                }
