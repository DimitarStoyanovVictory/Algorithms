namespace Problem01.DistanceBetweenVertices
{
    ...
    class Program
    {
            ...
            { 
                ...
                else
                {
                    ...
                    foreach (var element in graph[distanceToFind[indexDistanceToFind][0]])
                    {
                        ...
                        MakeSequance(graph, lastElement, visited, currentElement, count, ref resultCount);
                    }
                }
        ...
        private static void MakeSequance(List<List<int>> graph, int lastElement, bool[] visited, int currentElement, int count, ref int resultCount)
        {
            while (true)
            {
                ...
                if (currentElement == lastElement && count == resultCount)
                {
                    break;
                }
