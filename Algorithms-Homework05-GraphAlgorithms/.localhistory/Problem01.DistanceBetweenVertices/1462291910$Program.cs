namespace Problem01.DistanceBetweenVertices
{
    ...
    class Program
    {
            ...
            { 
                ...
                else
                {
                    ...
                    foreach (var element in graph[distanceToFind[indexDistanceToFind][0]])
                    {
                        ...
                        while (true)
                        {
                            GenerateSequace(ref graph, ref currentElement, lastElement, ref resultCount, ref count);
        ...
        private static void GenerateSequace(ref List<List<int>> graph, ref int currentElement, int lastElement, ref int resultCount, ref int count)
        {
