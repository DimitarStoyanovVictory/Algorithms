namespace Problem05.PathsBetweenCellsInMatrix
{
    ...
    public class PathsBetweenCellsInMatrix
    {
        ...
        private static void FindPath(char[][] matrix, int row = 0, int col = 0, string result = "", int step = 0)
        {
            while (step > 0)
            {
                ...
                FindPath(matrix, row, col, result, step);
            }
        }

        private static void PrintResult(string result, int step)
        {
