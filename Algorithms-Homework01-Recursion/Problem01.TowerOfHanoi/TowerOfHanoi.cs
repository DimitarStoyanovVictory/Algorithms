...
public class TowerOfHanoi
{
    ...
    private static void MoveDisks(int bottomDiskNumber, Stack<int> source, Stack<int> destination, Stack<int> spare)
    {
        ...
        MoveDisks(bottomDiskNumber - 1, source, spare, destination);
        destination.Push(source.Pop());
        step++;
        PrintRods(step, destination.Peek());
