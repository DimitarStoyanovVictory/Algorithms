namespace PermutationsInterativly
{
    ...
    class Permotations
    {
        ...
        private void CalculatePermutations(BigInteger firstNum, BigInteger lastNum, int n)
        {
        ...
        private bool IsAllowedNumber(BigInteger number, int n)
        {
        ...
        private bool CheckUnique(string number)
        {
        ...
        private BigInteger GenerateLastNum(int n)
        {
            string lastNumStr = "";
        ...
        private BigInteger GenerateFirstNum(int n)
        {
            string firstNumStr = "";
            for (int count = 0; count < n; count++)
            {
