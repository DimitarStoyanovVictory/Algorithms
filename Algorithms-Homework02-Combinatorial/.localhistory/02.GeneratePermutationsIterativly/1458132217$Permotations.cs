namespace PermutationsInterativly
{
    ...
    class Permotations
    {
        ...
        static void Main()
        {
            ...
            CalculatPermutatuions(arrayOfNumbers, n, movingIndex,numberOfInteration);
        ...
        private static void CalculatPermutatuions(int[] arrayOfNumbers, int n, int movingIndex, decimal numberOfInteration)
        {
            while (_numberofPermutations > 0)
            {
                if (((numberOfInteration - 1) / 6) % 2 == 0 && numberOfInteration != 1)
                {
                    Swap(ref arrayOfNumbers[n - movingIndex], ref arrayOfNumbers[n - movingIndex - 1]);
                }
